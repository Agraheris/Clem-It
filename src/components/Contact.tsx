      ...
      <form ref={form} onSubmit={sendEmail}>
        <div className="mb-4">
          ...
          <input
            ...
            id="name"
            name="user_name"
            className="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-800 focus:border-blue-800"
            required
          />
        </div>
        <div className="mb-4">
        ...
        <button
          type="submit"
          className="w-full bg-blue-800 text-white px-4 py-2 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-800 focus:ring-opacity-50"
